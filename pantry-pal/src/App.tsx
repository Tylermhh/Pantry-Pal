...
import Home, {PantryGroupType} from "./pages/Home.tsx";
...
import {useDataFetching} from "./pages/useDataFetching.ts";
...
function App() {
    ...
    const [pantryGroups, setPantryGroups] = useState<PantryGroupType[]>([]);
    useEffect(() => {
        setPantryGroups(pantryData);
    }, [pantryData])
    return (
        <Router>
            <Routes>
                <Route path="/" element={<MainLayout />}>
                    ...
                    <Route path="register" element={<RegisterPage setAuthToken={setAuthToken} setUserId={setUserId}/>} />
                    <Route path="login" element={<LoginPage setAuthToken={setAuthToken} setUserId={setUserId}/>} />
                </Route>
            </Routes>
        </Router>
    )
